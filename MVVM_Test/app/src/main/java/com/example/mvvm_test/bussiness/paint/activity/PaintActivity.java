package com.example.mvvm_test.bussiness.paint.activity;
...
import com.example.mvvm_test.bussiness.paint.view.CropView;
import com.example.mvvm_test.bussiness.paint.view.DecalView;
...
public class PaintActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    class MyAdapter extends RecyclerView.Adapter<MyViewHolder> {
        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
            ...
            ImageLoader.getInstance().init(ImageLoaderConfiguration.createDefault(PaintActivity.this));
            ImageLoader.getInstance().displayImage(decalList[position], holder.iv_decal);
//            Glide.with(getApplicationContext()).load(decalList[position]).into(holder.iv_decal);
        }
